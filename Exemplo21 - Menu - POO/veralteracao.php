...
<form name="produto" action="alterar.php" method="post">
	<b>C�digo:</b> 
	<input type="number" name="codigo" value='<?php echo $dados['codigo']; ?>' readonly><br><br>

	<b>Produto:</b> 
	<input type="text" name="produto" maxlength='80' style="width:550px" value='<?php echo $dados['produto']; ?>'><br><br>

	<b>Descri��o: </b>
	<br><textarea name="descricao" rows='3' cols='100' style="resize: none;" ><?php echo $dados['descricao']; ?></textarea><br><br>
